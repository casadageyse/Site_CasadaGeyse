    ...
    <footer className="bg-[#04040e] border-t border-white/[0.06] pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 mb-10">
          ...
          {/* Contato */}
          <div>
            <h4 className="text-white font-bold text-sm uppercase tracking-wide mb-4">Reservar Seu Quarto

            </h4>
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <a href="https://wa.me/554788142277?text=Ol%C3%A1%2C%20gostaria%20de%20saber%20mais%20informa%C3%A7%C3%B5es%20para%20reservar%20um%20quarto%21" target="_blank" rel="noreferrer"
              ...
              <li className="text-gray-600 text-xs">Penha — Armação e Centro</li>
              <li className="text-gray-600 text-xs">Barra Velha — Centro</li>
              <li className="text-gray-600 text-xs">Navegantes - Praia do Gravatá</li>
            </ul>
          </div>
        </div>
