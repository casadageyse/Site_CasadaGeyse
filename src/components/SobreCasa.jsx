  ...
  return (
    <section ref={sectionRef} className="py-24 bg-[#080822]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="sobre-text opacity-0 text-center max-w-3xl mx-auto mb-14">
          <p className="text-[11px] font-bold text-primary uppercase tracking-[0.22em] mb-4 flex items-center justify-center gap-3">
            <span className="w-8 h-px bg-primary inline-block" />
            Nossa História
            <span className="w-8 h-px bg-primary inline-block" />
          </p>
          <h2 className="text-4xl sm:text-5xl font-black text-white mb-6 leading-[1.05]">
            Quem é a Casa da Geyse?
          </h2>
        ...
        <div className="grid grid-cols-3 gap-6 max-w-2xl mx-auto">
          {STATS.map(({ num, suffix, label }) => (
            <div key={label} className="bg-white/[0.03] border border-white/[0.07] rounded-2xl p-6 text-center
              ...
              <div className="text-5xl font-black text-primary leading-none mb-2">
